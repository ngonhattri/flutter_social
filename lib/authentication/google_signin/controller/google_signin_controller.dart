...
final googleSignInProvider = StateNotifierProvider<GoogleSignInController, GoogleSignInState>(
    (ref) {
...
class GoogleSignInController extends StateNotifier<GoogleSignInState> {
  ...
  GoogleSignInController(this._authenticationRepository) : super(GoogleSignInState.initial);
